      ...
      <div className="container relative">
        <div className="d-flex">
          ...
          <div className="first-box">
            ...
            <p className="define">
              Our Expert web designers work together with you to write the scope
              of the project.
            </p>
          </div>
        </div>
        ...
        <div className="webc">
          <img src={webdesign} className="design" alt="webdesign" />
        </div>

        <div className="d-flex">
          <div className="first-box">
            <img src={architech} alt="architech" />
            <h3 className="heeed">3. Website Architecture</h3>
            <p className="define">
              The architecture of the website determines how the users will
          ...
          <div className="first-box">
            ...
            <p className="define">
              Our creative web designers in India then convert the architecture
              into visually appealing web design.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="d-flex  number">
          <div className="first-box1">
            ...
            <p className="define">
              Our web development team then convert these designs into fully
          ...
          <div className="first-box1">
            ...
            <p className="define">
              Our QA team tests the website in real online environment across
              all devices.
            </p>
          </div>
          <div className="first-box1">
            ...
            <p className="define">
              After launch we monitor the website for next two months free of
              cost to check the performance.
            </p>
          </div>
          <div className="first-box1">
