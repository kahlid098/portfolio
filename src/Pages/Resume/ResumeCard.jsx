      ...
      <div className="conatainer">
        ...
        <div className="reusable-compnent">
          <div className="reusable-card">
            ...
            <div class="content">
              <a href="#">
                <div className="title">Website Designing</div>
          ...
          <div className="reusable-card">
            ...
            <div className="content">
              <a href="#">
                <div className="title">Payment Gateway Integration</div>
                <div className="description">
          ...
          <div className="reusable-card">
            ...
            <div className="content">
              <a href="#">
                <div className="title">3rd Party APIs Integration</div>
                <div className="description">
          ...
          <div className="reusable-card">
            ...
            <div className="content">
              <a href="#">
                <div className="title">Cloud AWS, Azure hosting </div>
                <div className="description">
